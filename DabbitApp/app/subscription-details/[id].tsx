...
import { MOCK_SUBSCRIPTIONS } from '@/constants/mockEvents';
...
export default function SubscriptionDetailsScreen() {
  ...
  // Find the subscription based on the id param
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={[styles.discountInfoCard, { backgroundColor: colors.surface }]}>
            ...
            <Text style={[styles.discountInfoText, { color: colors.textSecondary }]}>
              You will use {subscription.pointsCost} Dabbit Coins to get ₹{subscription.originalPrice - subscription.discountedPrice} off.
          ...
          <Text style={[styles.termsText, { color: colors.textSecondary }]}>
            * This subscription discount is valid for 7 days from redemption. 
          ...
          <View style={styles.confirmModalContainer}>
            ...
            <View style={styles.confirmModalContent}>
              ...
              <View style={styles.confirmModalRow}>
                <Text style={styles.confirmModalLabel}>Subscription:</Text>
              ...
              <View style={styles.confirmModalRow}>
                ...
                <Text style={styles.confirmModalValue}>
                  {MOCK_COINS - subscription.pointsCost} DC
                </Text>
              </View>
            ...
            <View style={styles.confirmModalFooter}>
              <Text style={styles.confirmModalNote}>
                You can cancel this redemption within 24 hours without losing coins.
              </Text>
